...
#SBATCH --qos=normal
#SBATCH --job-name=kbm7-lncRNA-controls
#SBATCH --output=kbm7-lncRNA-controls.%j.out
...
rm -rf /scratch/alpine/wist9668/tmp/ControlData-KBM7-lncRNA_output/
rm -rf /scratch/alpine/wist9668/data/analyzed_data/synthetic_lethal_screens/ControlData-KBM7-lncRNA_output/
...
for REP in {1..3}; do
    ...
    ./analyze_sli.sh -C -R=${REP} -S=${FILES[$((REP-1))]} --name=ControlData-KBM7-lncRNA
