...
#SBATCH --qos=normal
#SBATCH --job-name=hap1-lncRNA
#SBATCH --output=hap1-lncRNA.%j.out
...
rm -rf /scratch/alpine/wist9668/tmp/ControlData-HAP1-lncRNA_output/
rm -rf /scratch/alpine/wist9668/data/analyzed_data/synthetic_lethal_screens/ControlData-HAP1-lncRNA_output/
...
for REP in {1..4}; do
    ...
    ./analyze_sli.sh -C -R=${REP} -S=${FILES[$((REP-1))]} --name=ControlData-HAP1-lncRNA
